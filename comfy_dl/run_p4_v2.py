...
SEED=70414
DEPTH=float(sys.argv[1]) if len(sys.argv)>1 else 0.55   # raise to 0.7 if geometry drifts (do NOT lower denoise)
CANNY=0.45
DENOISE=0.65
TAG=("d%02d"%(round(DEPTH*100)))
...
g={
 ...
 "20":{"class_type":"SaveImage","inputs":{"images":["8",0],"filename_prefix":"p4v2_base"}},
 ...
 "32":{"class_type":"SaveImage","inputs":{"images":["31",0],"filename_prefix":"p4v2_final"}},
}
...
if base: fetch(base, RENDERS+r"\cozinha_enscape_v2_base_"+TAG+".png")
out=RENDERS+r"\cozinha_enscape_v2_"+TAG+".png"
fetch(fin, out)
